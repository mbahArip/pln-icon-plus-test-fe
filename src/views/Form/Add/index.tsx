      ...
      {loading ? (
        <div className="grid min-h-[66dvh] place-items-center">
          <div className="flex flex-col items-center justify-center gap-2">
            <Icon name="LoaderCircle" className="size-10 stroke-form-primary animate-spin" />
            <p className="text-[12px] text-form-foreground opacity-80 animate-pulse">Sedang memuat data...</p>
          </div>
        </div>
      ) : error ? (
        <div className="grid min-h-[66dvh] place-items-center">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-start gap-5">
              <InputWrapper
                ...
                labelProps={{ htmlFor: "participant" }}
                error={formError.participant}
              >
                <Input
                  type="number"
                  id="participant"
            ...
            <div className="flex items-start gap-5">
              <InputWrapper
                ...
                labelProps={{ htmlFor: "consumption" }}
                error={formError.consumption}
              >
